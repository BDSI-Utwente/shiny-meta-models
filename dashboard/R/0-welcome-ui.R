...
welcomeUI <- tabItem(
  ...
  box(
    ...
    status = "primary",
    width = 12,
    p("This Probabilistic Analysis Check dashBOARD (PACBOARD) is an interactive tool to systematically validate and explore the results of a probabilistic analysis from a health economic model."),
    ...
    p("The Prepare data-tab: upload your data and group variables in 'costs', 'utilities', and 'probabilities'. You can also define whether you want to calculate the net benefits if the dataset does not contain it already."),
    p("The Summary statistics-tab: obtain summary statistics of the inputs and outputs, investigate the correlation between inputs and outputs, and perform the first quick check on your inputs and outputs."),
