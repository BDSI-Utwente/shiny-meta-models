...
welcomeUI <- tabItem(
  ...
  box(
    ...
    p("To use PACBOARD, you need a dataset (or dataframe) containing both inputs and (intermediate) outputs of a probabilistic analysis. The first row of the dataset should represent the input or output name."),
    ...
    p("The Metamodelling-tab: investigate the relation between model inputs and outputs using interactive graphs and metamodelling."),
    p("The Metamodel predictions-tab: use the metamodel you have fitted to make predictions."),
